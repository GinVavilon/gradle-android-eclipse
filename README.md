 [ ![Download](https://api.bintray.com/packages/ginvavilon/maven/Android-Eclipse/images/download.svg?version=0.9.5) ](https://bintray.com/ginvavilon/maven/Android-Eclipse/0.9.5/link)
...
buildscript {
    dependencies {
        classpath 'com.github.ginvavilon:android-eclipse:0.9.5'
    }
}
```
